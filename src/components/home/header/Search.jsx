...
const Search = ({ modal, setModal }) => {
  const style = {
    modal_container: `absolute sm:relative right-4 left-4 top-[4rem] sm:left-0 sm:top-0
                      ${modal ? "visible opacity-100" : "invisible opacity-0"} transition-all duration-100`,
    search_bar: `flex items-center gap-1 bg-gray-100 px-2 rounded-full relative z-10`,
